...
final class NodePermissions
{
    ...
    public const USER_CAN_EDIT_NODE = 'contao_user.nodeMounts';

    public const USER_CAN_CREATE_NODES = 'contao_user.nodePermissions.create';

    public const USER_CAN_EDIT_NODES = 'contao_user.nodePermissions.edit';

    public const USER_CAN_DELETE_NODES = 'contao_user.nodePermissions.delete';
